        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div class="bg-white shadow-md rounded-2xl p-6">
                    <h3 class="text-lg font-semibold text-gray-700 mb-2">Blood samples Available at the Facility</h3>
                    <p class="text-3xl font-bold text-red-600">{{ $samplesNr }}</p>
                </div>

                <div class="bg-white shadow-md rounded-2xl p-6">
                    <h3 class="text-lg font-semibold text-gray-700 mb-2">Blood samples Expired at the Facility</h3>
            ...
            <div class="grid grid-cols-1 gap-6 mt-4">
                <div class="bg-white shadow-md rounded-2xl p-6">
                    <h3 class="text-lg font-semibold text-gray-700 mb-2">Nurses registered with the Facility</h3>
                    <p class="text-3xl font-bold text-green-600">{{ $facilityNurses }}</p>
                </div>
            </div>
        </div>
